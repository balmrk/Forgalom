...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2022. Dec 03. 23:21
...
CREATE TABLE `aru` (
  `aru_kod` int(2) NOT NULL,
  `kat_kod` int(1) DEFAULT NULL,
  `nev` varchar(29) CHARACTER SET utf8 COLLATE utf8_hungarian_ci DEFAULT NULL,
  `egyseg` varchar(5) DEFAULT NULL,
...
CREATE TABLE `kategoria` (
  `kat_kod` int(1) NOT NULL,
  `kat_nev` varchar(11) CHARACTER SET utf8 COLLATE utf8_hungarian_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `aru`
  ADD CONSTRAINT `aru_ibfk_1` FOREIGN KEY (`kat_kod`) REFERENCES `kategoria` (`kat_kod`);

--
-- Megkötések a táblához `eladas`
--
ALTER TABLE `eladas`
  ADD CONSTRAINT `eladas_ibfk_1` FOREIGN KEY (`aru_kod`) REFERENCES `aru` (`aru_kod`);
COMMIT;
